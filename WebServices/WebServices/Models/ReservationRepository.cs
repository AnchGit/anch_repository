...
namespace WebServices.Models
{
    public class ReservationRepository
    {
        ...
        {
            new Reservation { ReservationId = 1, ClientName = "David", Location = "Board Room" },
            new Reservation { ReservationId = 2, ClientName = "Mark", Location = "Lecture Hall" },
            new Reservation { ReservationId = 3, ClientName = "Iggy", Location = "Meeting Room 1" }
        };
